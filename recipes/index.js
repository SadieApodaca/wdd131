...
//         // Code for going through each movie and creating content for that movie. Display a new movie card (HTML) for each movie in the array.

//     const card = `
//         <article class="recipe">
//             <h2>${recipe.name}</h2>
//             <img src="${recipe.image}">
//             <p><strong>Release Date:</strong> ${recipe.rating}</p>
//             <p><strong>Recommended Age:</strong> ${recipe.description}</p>
//             <p><strong>Rating:</strong> <span>${recipe.tags}</span></p>
//         </article>
//     `;
//     document.getElementById("recipe-list").innerHTML += card;
